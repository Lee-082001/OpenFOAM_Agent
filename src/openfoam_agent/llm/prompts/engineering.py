...
Runtime-repair phase: diagnose the actual selected OpenFOAM execution-driver log, inspect/modify the case as needed, and validate each
...
coverage are caught before consuming another native solver attempt, then use retry_solver as the final sequence action.
Do not change
